...
class Qwen_GR00T(baseframework):
    ...
    def forward(
        ...
        **kwargs,
        ...
        with torch.autocast("cuda", dtype=torch.float32):
            ...
            loss_dict = self.action_model(last_hidden_repeated, actions_target_repeated, state_repeated, 
                encoder_attention_mask=attention_mask_repeated, embodiment_id=embodiment_ids_repeated)  # (B, chunk_len, action_dim)
        return loss_dict
    ...
    def predict_action(
        ...
        **kwargs: str,
        ...
        with torch.autocast("cuda", dtype=torch.float32):
            pred_actions = self.action_model.predict_action(last_hidden, state, attention_mask, embodiment_ids)  # (B, chunk_len, action_dim)
