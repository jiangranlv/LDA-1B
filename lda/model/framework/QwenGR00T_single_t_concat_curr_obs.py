...
from LDA.model.modules.action_model.GR00T_ActionHeader_single_t_concat_curr_obs import get_action_model, FlowmatchingActionHead
    ...
    def forward(
        ...
        **kwargs,
        ...
        # with torch.autocast("cuda", dtype=torch.bfloat16):
            ...
            attention_mask = attention_mask.to(last_hidden.device, dtype=last_hidden.dtype).repeat(repeated_diffusion_steps, 1)
            ...
            output_dict = self.action_model(last_hidden_repeated, actions_target_repeated, 
                state_repeated, future_images_repeated, curr_images_repeated, embodiment_ids_repeated, tasks, encoder_attention_mask=attention_mask)  # (B, chunk_len, action_dim)
